...
<body>
	<nav>
		<img width="200px"> <span style="float: right; margin-right: 80px;">
			<center><img src="../simpangambar/<?php
				...
				<p style="text-transform:uppercase;font-weight: bold;color: white;">&nbsp;&nbsp;<?php echo $nama; ?></p>
				<li style="list-style: none;float: left;"><a href="profil" id="tomboll" style="padding:3px;border:1px solid white;">Profil</a></li>
